...
import img from "@/image/img-prov.jpg";
  ...
  return (
    <div className="py-24">
      ...
      <div className="flex items-center gap-7 mt-5">
        <div className="img-provider w-[50%] relative">
          <Image
            src={img}
            alt="img"
            className="bg-auto w-[100%] h-[550px] object-cover object-top"
          />
        </div>
        <div className="text-provider w-[50%] px-3">
